...
import ru.spbstu.icc.kspt.architecture.shalyapin.infrastructure.ICacheable;
...
public class Instrument implements ICacheable, IEnableable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ru.spbstu.icc.kspt.edu_arh.shalyapin.domain.IEnableable#isEnabled()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ru.spbstu.icc.kspt.edu_arh.shalyapin.domain.IEnableable#setEnabled()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ru.spbstu.icc.kspt.edu_arh.shalyapin.domain.IEnableable#setDisabled()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * ru.spbstu.icc.kspt.architecture.shalyapin.infrastructure.ICacheable#getId()
	 */
	@Override
	public Long getId() {
		return id;
